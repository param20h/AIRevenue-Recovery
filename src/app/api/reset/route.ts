...
async function executeReset() {
  // Make sure tables exist for serverless Vercel environments that use /tmp or new Turso databases
  await db.run(sql`
...
// Also allow GET so users can just visit the URL in the browser to trigger it easily!
